...
export const PROJECT_DATA: ProjectItem[] = [
  {
    ...
    collaborators: null,
    description:
      'Built an interactive e-learning platform that modernizes the experience of writing and validating COBOL and JCL through an integrated in-browser workspace.',
    techStack: [
      'React',
      'TypeScript',
      'TailwindCSS',
  ...
  },
  {
    ...
    collaborators: null,
    problem:
      'Frontend developers and QA testers often get blocked waiting for backend APIs to be ready. Existing API mocking tools are often either too complex, paid, or require tedious setup, leaving a gap for a free, plug-and-play local mock server.',
    description:
  ...
  },
  {
    ...
    problem:
      "The university's grievance and complaint handling relied heavily on manual paperwork, creating a slow and inefficient process. Students had to physically visit the office to submit complaints, and tracking the status across different college departments was difficult due to fragmented communication.",
    description:
      "Digitized and streamlined the university's end-to-end grievance handling workflow. Online complaint submissions are automatically routed to the OSAS head administrator for validation, after which valid claims can be endorsed to the complained party's respective college with a single click—replacing physical office visits. Built a real-time grievance tracking system that provides students with full transparency into the status and progress of their submitted concerns.",
    techStack: [
      'React.js',
      'TypeScript',
      'Tailwind CSS',
  ...
  },
  {
    ...
    collaborators: null,
    problem:
      'The business managed its class registrations and scheduling through manual Google Forms, which lacked automation and professional polish. This approach made tracking payments, managing class capacities, and coordinating schedules increasingly difficult as the business grew.',
    description:
      'Built a centralized management platform using Tanstack Start, replacing manual scheduling with a digital system for classes, coaches, and studio rentals. Enabled secure, automated transactions by integrating PayMongo, and designed an administrative dashboard.',
    techStack: [
      'Tanstack Start',
      'React',
      'PayMongo',
  ...
  },
  {
    ...
    description:
      'Developed an interactive web-based photobooth using NextJS to provide users with a fun, seamless, and engaging digital photography experience.',
  ...
  },
  {
    ...
    collaborators: null,
    problem:
      'Keeping track of multiple job applications, interview stages, and recruiter notes across various platforms and spreadsheets is messy and unorganized, making it easy to miss important updates or follow-ups during the job search process.',
    description:
      'A simple CRUD job application tracker that streamlines the job search process by organizing applications, statuses, and notes in a centralized dashboard.',
  ...
  },
  {
    ...
    collaborators: null,
    description:
      'A portfolio website built with Motion and ReactBits components that you are viewing right now. Showcases my skills and projects as well as my social media accounts.',
  ...
  },
  {
    ...
    description:
      'A final project presented during my 3rd year, 1st Semester in Web Systems and Technologies (1). A full-stack e-commerce application built with React (TypeScript) frontend and Express.js backend, featuring Firebase authentication and XML-based data storage.',
  ...
  },
  {
    ...
    description:
      'A final project presented during my 2nd year, 2nd Semester in Advanced Programming. A school management system designed in Java with MVC Framework. Features included Student, Faculty, and Admin Dashboards. Check the repository for more details.',
    techStack: ['Java', 'Java Swing', 'JDBC', 'MVC Framework', 'SQL Server', 'Agile Development'],
    image:
      'https://placehold.co/800/darkblue/white?text=School+Management+System&font=playfair-display',
