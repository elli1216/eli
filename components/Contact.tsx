      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8 flex flex-col justify-center">
            <a href="mailto:eli@example.com" className="flex items-center gap-4 group p-4 rounded-lg hover:bg-accent transition-colors">
              ...
              <div>
                ...
                <p className="text-muted-foreground">eli@example.com</p>
              </div>
            </a>
            
            <a href="#" className="flex items-center gap-4 group p-4 rounded-lg hover:bg-accent transition-colors">
              <div className="p-3 bg-accent text-primary rounded-full group-hover:scale-110 transition-transform">
                <Linkedin size={24} />
              </div>
              <div>
